   ...
   <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
    {fakeData.map((item) => (
     <Card
      ...
      key={item.id}
      className="rounded flex flex-col bg-white overflow-hidden shadow-none transition-shadow duration-400 cursor-pointer hover:shadow-lg hover:shadow-gray-400"
     >
